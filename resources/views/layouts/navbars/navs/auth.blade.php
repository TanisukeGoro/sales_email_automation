...
<nav class="navbar navbar-top navbar-expand-md navbar-dark border-bottom border-black" id="navbar-main">
  <div class="container-fluid">
    <div class="header-left">
      <!-- Brand -->
      <a class="h4 mb-0 text-black text-uppercase d-none d-lg-inline-block" href="{{ route('home') }}">営業支援サービス</a>
      <!-- button -->
      <button type="button" class="btn btn-outline-primary btn-sm ml-3">営業先リスト</button>
    ...
    <div class="header-right d-flex align-items-center">
      <p class="remainder-text m-0">残り8件</p>
      <!-- User -->
